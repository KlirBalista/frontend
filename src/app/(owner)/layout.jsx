...
const AppLayout = ({ children }) => {
  ...
  return (
    <div className={`min-h-screen bg-white transition-all duration-300`} id="app-layout">
      <Navigation user={user} />
      <main className="lg:ml-80 transition-all duration-300 pt-16 lg:pt-3 lg:mr-3 min-h-screen">
        <div className="p-4 lg:p-0 h-full">
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 h-[calc(100vh-8rem)] lg:h-[calc(100vh-1.5rem)]">
